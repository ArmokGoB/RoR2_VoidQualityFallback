...
## The Problem
As of 2026-05-04, the current functionality of Quality and mods that add void items do not account for one another, causing quality variants of items with a modded void variant to not convert. This can lead to item combinations that should not be possible, such as having Abyss-Touched Adze alongside quality Crowbar.
